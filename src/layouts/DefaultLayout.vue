<template>
  <el-container class="layout-container">
    <el-aside :width="isCollapse ? '64px' : '220px'" class="layout-aside">
      <div class="logo">
        <el-icon class="logo-img" color="#409eff" size="24"><Document /></el-icon>
        <span class="logo-text" v-show="!isCollapse">MES 生产管理系统</span>
      </div>
      <el-menu
      ...
      >
        ...
        <el-menu-item index="/production">
          ...
          <template #title>生产订单</template>
        </el-menu-item>
        <el-menu-item index="/scheduling">
          <el-icon><Calendar /></el-icon>
          <template #title>生产排程</template>
        </el-menu-item>
